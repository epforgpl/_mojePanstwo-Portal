        ...
        d3.json("/dane/" + connectionGraph.data('url') + "/" + connectionGraph.data('id') + "/graph.json", function (error, graph) {
            ...
            var circle = d3Data.innerContainer.append("svg:g").selectAll("circle")
                ...
                .style("fill", function (d) {
                    return (d.id === root.id) ? d3Data.color.mainFill : d3Data.color[d.label];
                });
            ...
            function collide(node) {
                if (node.y < ((d3Data.size.nodesPodmiot > d3Data.size.nodesOsoba) ? d3Data.size.nodesPodmiot : d3Data.size.nodesOsoba)) {
                    node.y -= node.y - ((d3Data.size.nodesPodmiot > d3Data.size.nodesOsoba) ? d3Data.size.nodesPodmiot : d3Data.size.nodesOsoba);
                }
