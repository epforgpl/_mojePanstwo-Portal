	...
	if (connectionGraph.length > 0) {
		d3.json("/dane/" + connectionGraph.data('url') + "/" + connectionGraph.data('id') + "/graph.json", function (error, graph) {
				...
				d3Data.innerContainer.append("svg:defs").selectAll("marker")
					...
					.attr("orient", "auto")
					.append("svg:path")
					.attr("d", "M 0,0 0," + d3Data.size.nodesMarkerSize + " L" + d3Data.size.nodesMarkerSize * .5 + "," + d3Data.size.nodesMarkerSize * .5 + " Z");
				...
				d3Data.innerContainer.append("svg:defs").selectAll("marker")
					...
					.attr("refX", d3Data.size.nodesMarkerSize * .5)
					.attr("refY", d3Data.size.nodesMarkerSize * .5)
					.attr("markerWidth", d3Data.size.nodesMarkerSize)
					.attr("markerHeight", d3Data.size.nodesMarkerSize)
					.attr("orient", "auto")
					.append("svg:path")
					.attr("d", "M" + d3Data.size.nodesMarkerSize * .75 + ",0 0," + d3Data.size.nodesMarkerSize * .75 + " L" + d3Data.size.nodesMarkerSize * .75 + "," + d3Data.size.nodesMarkerSize * .75 + " Z");
