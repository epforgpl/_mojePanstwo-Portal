...
class Zamowienia_publiczne_dokumenty extends DocDataObject
{
    ...
    public function getShortTitle()
    {
        ...
        switch ($this->getData('typ_id')) {
            case '1':
                return 'Ogłoszenie zamówienia';
            case '2':
                return 'Ogłoszenie zamówienia';
            case '3':
                return 'Udzielenie zamówienia';
            case '4':
                return 'Ogłoszenie konkursu';
            case '5':
                return 'Ogłoszenie wyników konkursu';
            case '6':
                return 'Zmiana zamówienia';
            case '7':
                return 'Zamiar zawarcia umowy';
            default:
                return 'Ogłoszenie';
        }
