				...
				<div class="col-xs-12 col-sm-8 col-md-4-5 norightpadding">
				    ...
				    <div class="dataWrap">
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Swagger i API Discovery</header>
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Standardowy mechanizm wyszukiwania danych</header>
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Identyfikatory obiektów</header>
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Warstwy danych</header>
...

{
    ...
    "layers": {
        ...
        "dataset": null
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Obsługa błędów</header>
...
{"errors": {
    ...
    ...
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Wersjonowanie</header>
