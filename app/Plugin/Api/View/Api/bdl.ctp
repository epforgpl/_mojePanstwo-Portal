				...
				<div class="col-xs-12 col-sm-8 col-md-4-5 norightpadding">
				    ...
				    <div class="dataWrap">
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Dokumentacja żądań</header>
				        ...
				        <p>Bank danych lokalnych jest skomplikowaną strukturą danych, jednak dostęp do niej można podzielić na cztery proste kroki:</p> 				        				        
				        
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Wybór wskaźnika [metric_id]</header>
					        
					        <section class="content margin-top-15">
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Wybór przekroju [slice]</header>
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Wybór szczegółowości danych wg. rejonu [wojewodztwo_id,powiat_id,gmina_id]</header>
				        ...
				        <div class="block block-simple margin-top-20">
					        <header class="nopadding">Wybór okresu czasu [time_range]</header>
