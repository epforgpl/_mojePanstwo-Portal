    ...
    <dl>
        ...
        <dd>
            ...
            w grupy oraz kategorie.
                ...
                Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/search?q=bezrobotni">Wyszukaj statystyki dotyczące bezrobotnych</a><br/>
        ...
        <dd>
            ...
            <ul>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762">Wszystkie przekroje</a></li>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,1713]">Bezrobotni mężczyźni z wyższym wykształceniem</a></li>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,*]">Bezrobotni mężczyźni i kobiety z wyższym wykształceniem</a></li>
            </ul>
        </dd>
        ...
        <dd>
            ...
            <ul>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,1713]">Dane na poziomie kraju</a></li>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,1713]&wojewodztwo_id=*">Dane dla wszystkich województw</a></li>
                <li>Przykład: <a href="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,1713]&powiat_id=2">Powiat augustowski</a></li>
            </ul>
        </dd>
        ...
        <dd>
            ...
            <ul>
                <li>Przykład: <a hreg="http://api-v2.mojepanstwo.pl/bdl/series?metric_id=762&slice=[5479,1713]&time_range=2001:2002">Bezrobotni w latach 2001:2002</a></li>
            </ul>
        </dd>
    </dl>
