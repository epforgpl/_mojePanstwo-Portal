                ...
                <div class="col-xs-12 col-sm-8 col-md-4-5 norightpadding">
                    <div class="dataWrap">
                        ...
                        <div class="daneOsobowe block col-xs-12">
                            ...
                            <section>
                                <p><strong>Sposób pozyskania danych.</strong><br/>Portal mojepanstwo.pl wydawany jest
                                    ...
                                    poz. 1142) w Krajowym Rejestrze Sądowym (dalej: KRS) oraz&nbsp;Monitorze Sądowym i&nbsp;Gospodarczym
                                    (dalej: Monitor). Zgodnie z&nbsp;art. 8 ust. 1 powołanej ustawy rejestr jest jawny,
                                    a istotą Monitora Sądowego i&nbsp;Gospodarczego jest umieszczenie go obiegu
                                    publicznym (art. 13). Fundacja pozyskuje dane z&nbsp;powszechnie dostępnych źródeł i&nbsp;publikuje
                                ...
                                <p><strong>Przetwarzanie i&nbsp;rozpowszechnianie danych.</strong><br/>Przetwarzając
                                    ...
                                    gwarantowane jest art. 54 ust. 1 Konstytucji Rzeczypospolitej Polskiej z&nbsp;dnia 2
                                    kwietnia 1997&nbsp;r. (Dz.U. 1997 nr 78 poz.483 z&nbsp;późn. zm.) oraz art. 2a ust.
