...
var MapBrowser = Class.extend({
	...
	_desc: {
		'index': ['Zdrowotny Indeks Jakości Powietrza', '<div class="alert alert-danger metrics"><p class="metric">Wartości <span class="value">1 &mdash; 3</span> oznaczają <span class="value">niskie</span> ryzyko wzrostu śmiertelności (1.5 &mdash; 6.0%)</p><p class="metric">Wartości <span class="value">4 &mdash; 6</span> oznaczają <span class="value">średnie</span> ryzyko wzrostu śmiertelności (6.1 &mdash; 10.6%)</p><p class="metric">Wartości <span class="value">7 &mdash; 9</span> oznaczają <span class="value">wysokie</span> ryzyko wzrostu śmiertelności (10.7 &mdash; 15.3%)</p><p class="metric">Wartość <span class="value">10</span> oznacza <span class="value">bardzo wysokie</span> ryzyko wzrostu śmiertelności (powyżej 15.3%)</p></div><p class="text">Zdrowotny Indeks Jakości Powietrza to wskaźnik obliczany na podstawie stężeń pyłów, ołowiu, czadu i innych składników w powietrzu. Indeks przyjumje wartości od 0 do 10 i obrazuje wzrost ryzyka śmiertelności ludności ze wględu na zanieczyszczenie powietrza.</p>', false],
		'PM10': ['Pył PM10', '<div class="alert alert-danger metrics"><p class="metric">Poziom dopuszczalny dla stężenia średniodobowego: <span class="value">50 µg/m<sup>3</sup></span> <span class="additional_desc">Może być przekraczany nie więcej niż 35 dni w ciągu roku.</span></p><p class="metric">Poziom dopuszczalny dla stężenia średniorocznego: <span class="value">40 µg/m<sup>3</sup></span></p><p class="metric">Poziom alarmowy: <span class="value">200 µg/m<sup>3</sup></span></p></div><p class="text">Pył PM10 składa się z mieszaniny cząstek zawieszonych w powietrzu, będących mieszaniną substancji organicznych i nieorganicznych. Pył zawieszony może zawierać substancje toksyczne takie jak wielopierścieniowe węglowodory aromatyczne (np. benzo/a/piren), metale ciężkie oraz dioksyny i furany. Pył PM10 zawiera cząstki o średnicy mniejszej niż 10 mikrometrów, które mogą docierać do górnych dróg oddechowych i płuc.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=PM10_i_PM25'],
		'PM2_5': ['Pył PM2,5', '<div class="alert alert-danger metrics"><p class="metric">Docelowa wartość średnioroczna: <span class="value">25 µg/m<sup>3</sup></span></p><p class="metric">Poziom dopuszczalny: <span class="value">25 µg/m<sup>3</sup></span></p><p class="metric">Poziom dopuszczalny powiększony o margines tolerancji dla 2012 r.: <span class="value">27 µg/m<sup>3</sup></span></p></div><p class="text">Pył PM2,5 zawiera cząstki o średnicy mniejszej niż 2,5 mikrometra, które mogą docierać do górnych dróg oddechowych, płuc oraz przenikać do krwi.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=PM10_i_PM25'],
		'O3': ['Ozon', '<div class="alert alert-danger metrics"><p class="metric">Poziom docelowy stężenia 8-godzinnego: <span class="value">120 µg/m<sup>3</sup></span> <span class="additional_desc">Może być przekraczany nie więcej niż 25 dni w ciągu roku.</span></p><p class="metric">Poziom informowania społeczeństwa: <span class="value">180 µg/m<sup>3</sup></span></p><p class="metric">Poziom alarmowy: <span class="value">240 µg/m<sup>3</sup></span></p></div><p class="text">Ozon to odmiana tlenu o cząsteczce trójatomowej. Jest to drażniący gaz o barwie bladoniebieskiej i charakterystycznej woni. Ozon obecny w warstwie atmosfery przy powierzchni ma negatywny wpływ na zdrowie ludzkie i roślinność. Jest jednym ze składników smogu fotochemicznego, powstającego głównie latem przy wysokich temperaturach i ciśnieniu w miastach o bardzo dużym ruchu samochodowym, ale najwyższe stężenia mogą występować na obszarach pozamiejskich dokąd transportowane są prekursory ozonu z miasta.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=O3&t=3'],
		'CO': ['Czad', '<div class="alert alert-danger metrics"><p class="metric">Najwyższe dopuszczalne stężenie: <span class="value">23000 µg/m<sup>3</sup></span></p><p class="metric">Najwyższe dopuszczalne stężenie chwilowe: <span class="value">117000 µg/m<sup>3</sup></span></p></div><p class="text">Tlenek węgla powstaje w trakcie procesów spalania przy niedoborze tlenu. Naturalnymi źródłami emisji są erupcje wulkanów i pożary lasów. W ramach działalności człowieka największą emisję tlenku węgla powodują: przemysł energetyczny, hutniczy i chemiczny. Poza tym znacząca emisja tlenku węgla pochodzi od spalania paliw w pojazdach samochodowych, kotłach domowych opalanych węglem, a także ze spalania odpadów i suchych pozostałości roślinnych.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=CO&t=3'],
		'C6H6': ['Benzen', '<div class="alert alert-danger metrics"><p class="metric">Poziom dopuszczalny: <span class="value">5 µg/m<sup>3</sup></span></p></div><p class="text">Benzen jest jednym z najbardziej rozpowszechnionych związków organicznych, otrzymywanych z ropy naftowej Jest dobrym rozpuszczalnikiem m. in. tłuszczów, wosków, naftalenu. Spala się kopcącym płomieniem. Toksyczny, rakotwórczy, wykazuje działanie narkotyczne. Otrzymywany jest na wielką skalę w czasie przeróbki węgla kamiennego (smoła węglowa) i ropy naftowej. Służy jako surowiec do syntez tworzyw sztucznych, barwników, detergentów i farmaceutyków.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=benzen'],
		'NO2': ['Dwutlenek azotu', '<div class="alert alert-danger metrics"><p class="metric">Poziom dopuszczalny dla jednogodzinnego stężenia: <span class="value">200 µg/m<sup>3</sup></span> <span class="additional_desc">Może być przekraczany nie więcej niż 18 razy w ciągu roku.</span></p><p class="metric">Poziom dopuszczalny dla stężenia średniorocznego: <span class="value">40 µg/m<sup>3</sup></span></p><p class="metric">Poziom alarmowy dla stężenia jednogodzinnego: <span class="value">400 µg/m<sup>3</sup></span></p></div><p class="text">Dwutlenek azotu to brunatny, silnie toksyczny gaz o ostrym zapachu. Jest to substancja oddziaływująca w sposób szkodliwy na roślinność i zdrowie ludzkie.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=NO2'],
		'SO2': ['Dwutlenek siarki', '<div class="alert alert-danger metrics"><p class="metric">Poziom dopuszczalny stężenia jednogodzinnego: <span class="value">350 µg/m<sup>3</sup></span> <span class="additional_desc">Może być przekraczany nie więcej niż 24 razy w ciągu roku.</span></p><p class="metric">Poziom dopuszczalny stężenia średniodobowego: <span class="value">125 µg/m<sup>3</sup></span> <span class="additional_desc">Może być przekraczany nie więcej niż 3 razy w ciągu roku.</span></p><p class="metric">Poziom alarmowy stężenia jednogodzinnego: <span class="value">500 µg/m<sup>3</sup></span></p></div><p class="text">Dwutlenek siarki to bezbarwny gaz o ostrym, gryzącym i duszącym zapachu, silnie drażniący drogi oddechowe. Wchłaniany jest do organizmu człowieka przez błonę śluzową nosa i górny odcinek dróg oddechowych. Jest trujący dla zwierząt i szkodliwy dla roślin. Gaz ten wchodzi w reakcję z parą wodną zawartą w powietrzu, w wyniku czego stanowi główna przyczynę powstawania kwaśnych deszczów. Stanowi także składnik smogu w wielkich aglomeracjach miejskich.</p>', 'http://sojp.wios.warszawa.pl/index.php?page=SO2'],
    ...
    setSelectedOption: function(optionIndex) {
        ...
        if(self.options.hasOwnProperty(optionIndex)) {
			...
			var text = self._desc[option.short][1];
			if( self._desc[option.short][2] )
				text = text + ' <a target="_blank" href="' + self._desc[option.short][2] + '">Źródło</a>';
			$('#paramDesc').html( text );
