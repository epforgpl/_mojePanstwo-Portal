...
class ApiAppsController extends StartAppController
{
    public $chapter_selected = 'api_keys';
    public $components = array('Paginator');
    public $uses = array('Start.ApiApp', 'Paszport.User');

    public function index() {
        $this->title = 'Klucze API';
...
//            );
            ...
            $apps = array_map(function ($a) {
                return array('ApiApp' => array_intersect_key($a['ApiApp'], array_flip(array(
