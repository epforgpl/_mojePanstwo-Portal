...
echo $this->Html->script('../plugins/pickadate.js/lib/compressed/picker.js', array('block' => 'scriptBlock'));
echo $this->Html->script('../plugins/pickadate.js/lib/compressed/picker.date.js', array('block' => 'scriptBlock'));
echo $this->Html->script('../plugins/pickadate.js/lib/compressed/picker.time.js', array('block' => 'scriptBlock'));
echo $this->Html->script('../plugins/pickadate.js/lib/compressed/translations/pl_PL.js', array('block' => 'scriptBlock'));

echo $this->Html->css('../plugins/pickadate.js/lib/themes/default.css');
echo $this->Html->css('../plugins/pickadate.js/lib/themes/default.date.css');
?>
