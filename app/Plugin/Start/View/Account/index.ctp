        ...
        <div class="objectsPage">
            <div class="col-md-12">
                ...
                <div class="mainForm">
                    ...
                    <button type="button" id="deletePaszportButton" class="btn btn-default remove-button margin-top-20"
                            data-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="submitDeletePaszport" class="btn btn-primary">Potwierdź
                                    </button>
                                </div>
                            </div>
                        </div>
