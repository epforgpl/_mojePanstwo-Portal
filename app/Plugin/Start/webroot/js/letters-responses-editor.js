...
LetterResponseEditor.prototype = {
    ...
    editView: function() {
        ...
        content += '<div class="dropzoneForm"><div class="actions"><button class="btn btn-sm btn-default btn-addfile" type="button">Dodaj załącznik</button></div><div class="dropzoneFormPreview" id="preview_' + self.index + '"></div></div></div><div class="form-group overflow-hidden text-center margin-top-20"><button class="btn btn-default abortChanges" type="button">Anuluj</button><button class="btn auto-width btn-primary btn-icon" type="submit"><i class="icon glyphicon glyphicon-edit"></i>Zapisz zmiany</button></div></fieldset></form></div>';
