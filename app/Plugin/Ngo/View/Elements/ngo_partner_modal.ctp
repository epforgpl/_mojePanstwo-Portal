<div class="modal fade" id="ngoPartnerModal" tabindex="-1" role="dialog" aria-labelledby="ngoPartnerModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="ngoPartnerModalLabel">Zostań oficjalnym partnerem mojegoPaństwa</h4>
            </div>
