            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 widget-localize">
                        <p class="text-center">
                            <a href="/mapa/miejsce/253272?n=25&widget" class="btn btn-primary btn-icon auto-width"><i
                                    class="icon" data-icon="&#xe800;"></i>Zlokalizuj się</a> <span class="txt">lub znajdź swój adres:</span>
                        </p>
                    </div>
