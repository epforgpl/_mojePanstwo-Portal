...
WybierzPoslaModal.prototype.initialize = function() {
    ...
    $.getJSON('/dane/poslowie.json?conditions[poslowie.kadencja]=8&conditions[poslowie.mandat_wygasl]=0&conditions[poslowie.sejm_okreg_id]=' + id_okregu, function(res) {
        _this.res = res;
