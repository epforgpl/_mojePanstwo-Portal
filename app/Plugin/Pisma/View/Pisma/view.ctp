	                            ...
	                            <? if( $pismo['access']=='private' ) { ?>
		                            <li class="inner-addon">
		                            	<form action="" method="post">
			                                ...
			                                <p><b>To pismo jest prywatne.</b> Tylko Ty masz do niego dostęp. <button class="clean" type="submit">Kliknij, aby udostępnić to pismo publicznie.</button></p>
		                            	</form>
		                            </li>
	                            <? } elseif( $pismo['access']=='public' ) { ?>
	                            	<li class="inner-addon">
		                            	<form action="" method="post">
			                                ...
			                                <p><b>To pismo jest publiczne.</b> <button class="clean" type="submit">Kliknij, aby zmienić jego widoczność na prywatną.</button></p>
		                            	</form>
		                            </li>
	                            <? } ?>
	                                                    ...
	                                                    <div class="modal-body">
	                                                        ...
	                                                        <? if ($this->Session->read('Auth.User.id')) { ?>
	                                                            ...
	                                                            <div class="additional-desc">
	                                                                ...
	                                                                <p>W polu <b>Reply-to</b> wiadomości również zostanie
	                                                                    podany
