        ...
        <div class="editor-tooltip">
            ...
            <ul class="form-buttons">
                ...
                <li class="inner-addon">
                    ...
                    <p class="desc">Twoje pismo jest obecnie prywatne. Możesz je zanonimizować i udostępnić publicznie.</p>
                </li>   
                <li class="inner-addon">
                    <i class="glyphicon glyphicon-print"></i>
                    <a href="<?= $href_base . '/print' ?>" target="_self" class="btn btn-primary">Edytuj treść...</a>
                </li>
