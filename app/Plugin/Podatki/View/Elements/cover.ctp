...
<div id="podatki" class="col-xs-12">
    ...
    <form method="post">                
        <div class="row section">
            <div class="form-inline col-xs-12 col-sm-6 col-sm-offset-2" data-number="1">
                ...
                <button class="btn btn-default btn-xs btn-icon pull-right" data-type="przychody_umowa_o_prace"><i
        ...
        <div class="row section">
            <div class="form-inline col-xs-12 col-sm-6 col-sm-offset-2" data-number="1">
                ...
                <span class="info"><?= __d('podatki', 'LC_PODATKI_INFO_FULL'); ?></span>
                <button class="btn btn-default btn-xs btn-icon pull-right" data-type="przychody_umowa_zlecenie"><i
                        class="icon glyphicon glyphicon-plus"></i><?= __d('podatki', 'LC_PODATKI_ADD_NEW_UMOWA'); ?>
                </button>
            </div>
        </div>
        <div class="row section">
            <div class="form-inline col-xs-12 col-sm-6 col-sm-offset-2" data-number="1">
                ...
                <span class="info"><?= __d('podatki', 'LC_PODATKI_INFO_FULL'); ?></span>
                <button class="btn btn-default btn-xs btn-icon pull-right" data-type="przychody_umowa_o_dzielo"><i
                        class="icon glyphicon glyphicon-plus"></i><?= __d('podatki', 'LC_PODATKI_ADD_NEW_UMOWA'); ?>
                </button>
            </div>
        </div>
        <div class="row section">
            <div class="form-inline col-xs-12 col-sm-6 col-sm-offset-2" data-number="1">
                ...
                <button class="btn btn-default btn-xs btn-icon pull-right"
        ...
        <div class="action">
            <button class="btn btn-primary btn-lg btn-icon"><i
