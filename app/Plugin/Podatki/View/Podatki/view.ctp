        ...
        <div id="results" class="container">
            <div class="progress">
                <div class="progress-bar progress-bar-us"
                     ...
                     style="width: <?= $this->Number->toPercentage((($result_sum['us'] / $result_sum['total']) * 100) - 0.01) ?>">
                ...
                <div class="progress-bar progress-bar-us-pracodawca"
                     ...
                     data-html="true" data-toggle="tooltip" data-placement="top"
                     style="width: <?= $this->Number->toPercentage((($result_sum['us_pracodawca'] / $result_sum['total']) * 100) - 0.01) ?>">
                ...
                <div class="progress-bar progress-bar-zus"
                     ...
                     data-html="true" data-toggle="tooltip" data-placement="top"
                     style="width: <?= $this->Number->toPercentage((($result_sum['zus'] / $result_sum['total']) * 100) - 0.01) ?>">
                ...
                <div class="progress-bar progress-bar-pit"
                     ...
                     data-html="true" data-toggle="tooltip" data-placement="top"
                     style="width: <?= $this->Number->toPercentage((($result_sum['pit'] / $result_sum['total']) * 100) - 0.01) ?>">
                ...
                <div class="progress-bar progress-bar-vat"
                     ...
                     data-html="true" data-toggle="tooltip" data-placement="top"
                     style="width: <?= $this->Number->toPercentage((($result_sum['vat'] / $result_sum['total']) * 100) - 0.01) ?>">
                ...
                <div class="progress-bar progress-bar-akcyza"
                     ...
                     data-html="true" data-toggle="tooltip" data-placement="top"
                     style="width: <?= $this->Number->toPercentage((($result_sum['akcyza'] / $result_sum['total']) * 100) - 0.01) ?>">
