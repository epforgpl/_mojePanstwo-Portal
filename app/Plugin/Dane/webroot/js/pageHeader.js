jQuery(document).ready(function () {
    ...
    if (headerExtend.length) {
        ...
        headerExtend.css('min-height', Math.floor(parseInt(headerExtend.css('max-height')) - $(window).scrollTop()));

        $(window).scroll(function (event) {
            var scroll = $(window).scrollTop(),
                newHeight = Math.floor(parseInt(headerExtend.css('max-height')) - scroll);
