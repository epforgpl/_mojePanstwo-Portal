...
$(document).ready(function () {
	options = {
		...
		styles: [
			{
				featureType: "administrative.local_parcel",
				elementType: "labels",
	...
	function load_layers(data) {
		...
		$.each(data, function () {
			...
			var dzielnica = new google.maps.Polygon({
				paths: [
					google.maps.geometry.encoding.decodePath($(this)[0]['Dzielnice']['spat'])
				],
				fillColor: "#ff0000",
				fillOpacity: .05,
				strokeOpacity: 0.8,
			...
			dzielnica.setMap(map);
		})
	};


	$('#administrative_locality').click(function () {
		var tempstyle = [
			{
				featureType: "administrative.local_parcel",
				elementType: "labels",
		...
		options.styles = tempstyle;

		map.setOptions(options);
	});
	$('#administrative_neighborhood').click(function () {
		var tempstyle = [
			{
				featureType: "administrative.local_parcel",
				elementType: "labels",
	...
	$('#road_highway_controlled_access').click(function () {
		var tempstyle = [
			{
				featureType: "administrative",
				elementType: "labels",
