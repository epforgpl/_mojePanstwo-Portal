...
<div class="row margin-top-20">
                    ...
                    <div class="dataAggs">
                        <div class="agg agg-Dataobjects">
                            <? if ($dataBrowser['aggs']['rada_projekty']['top']['hits']['hits']) { ?>
                                ...
                                <div class="buttons">
                                    <a href="<?= $object->getUrl() ?>/druki" class="btn btn-default btn-xs">Zobacz
                                        więcej</a>
                                </div>
                            <? } ?>
                        ...
                        <div class="dataAggs">
                            <div class="agg agg-Dataobjects">
                                ...
                                <div class="buttons btn-sm text-center">
                                    <a href="<?= $object->getUrl() ?>/prawo" class="btn btn-default btn-xs">Zobacz
                                        więcej</a>
                                </div>
            ...
            <div class="block  block-simple  col-xs-12">
                ...
                <section class="aggs-init margin-sides-20 margin-top-10">
                    <? foreach ($udzialy as $udzial) { ?>
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="/dane/krs_podmioty/<?= $udzial['pozycja_id'] ?>,<?= $udzial['slug'] ?>"
                                   title="<?= $udzial['nazwa'] ?>">
                                    <?= $udzial['nazwa'] ?>
                                </a>
                            </div>
    ...
    <div class="col-md-3 sidebar">
        <? if ($object->getId() == 903) { ?>
            <div class="DataObjectOptions pk">
