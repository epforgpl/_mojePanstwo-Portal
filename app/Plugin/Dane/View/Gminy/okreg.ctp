            ...
            <div class="block block-simple col-xs-12">
                <section class="aggs-init margin-sides-10">
                    ...
                    <ul class="dataHighlights oneline">
			            ...
			            normy przedstawicielstwa, zaokrągla się w górę do liczby całkowitej.">Norma
                                przedstawicielstwa</p>
                            <?
        ...
        <div class="col-sm-5">
            ...
            <div class="block col-xs-12 margin-top-10">
                ...
                <section class="aggs-init nopadding">
                    ...
                    <div data-name="okreg" data-content='<?= json_encode($okreg->getLayers('geo')['geo']); ?>'></div>
                </section>
            </div>
