    ...
    <div class="Towar">
		...
		<div class="row">
	        <div class="col-lg-12">
		        ...
		        <h2>Wykres highCharts pokazujący import/eksport danego towaru w czasie.</h2>
		...
		<div class="row">
	        <div class="col-lg-6">
		        ...
		        <p>Lista państw o największej wartości importu dla danego towaru w danym roku</p>
	        ...
	        <div class="col-lg-6">
		        ...
		        <p>Lista towarów o największej wartości eksportu dla danego towaru w danym roku</p>
