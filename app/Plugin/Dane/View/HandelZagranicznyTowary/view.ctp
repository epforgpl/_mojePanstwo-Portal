        ...
        <div class="Towar">
            ...
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <p style="font-size: 11px; margin-bottom: 20px;" class="chart-desc text-center">Dane za 2015 r. są wstępne i dotyczą pierwszych trzech kwartałów.</p>
                </div>
            </div>
        </div>
    </div>
...
<!--
    ...
    <script type="text/javascript">
        ...
        var _year = '<? echo isset($_GET['y']) ? (int)$_GET['y'] : 2015; ?>';
    </script>
