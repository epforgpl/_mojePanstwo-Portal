/*global jQuery,window,document,TweenMax,TimelineMax,ScrollMagic*/
var infoController;
...
jQuery(function ($) {
	...
	function onResize() {
		...
		$story.css({'width': screenWidth, 'height': $window.height() - $header});
		$story.find('.far, .medium, .near').css({
