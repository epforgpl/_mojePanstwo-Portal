...
$(function () {
	$.getJSON('/WyjazdyPoslow/files/world.geo.json', function (geojson) {
		...
		$.getJSON('https://api-v3.mojepanstwo.pl/wyjazdyposlow/world', function (statsData) {
					...
					events: {
						click: function (e) {
							if (e.point) {
								...
								$.getJSON('https://api-v3.mojepanstwo.pl/wyjazdyposlow/countryDetails/' + e.point.code.toLowerCase(), function (detail) {
