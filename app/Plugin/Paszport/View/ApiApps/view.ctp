    ...
    <div class="mainBlock col-xs-12 col-md-6">
        ...
        <div class="apiApps view">
            ...
            <div class="optionsBtn col-xs-12">
                <?php echo $this->Html->link(__('List Api Apps'), array('action' => 'index'), array('class' => 'btn btn-default pull-left')); ?>
                <?php echo $this->Html->link(__('Edit Api App'), array('action' => 'edit', $apiApp['ApiApp']['id']), array('class' => 'btn btn-warning pull-right')); ?>
                <?php echo $this->Form->postLink(__('Delete Api App'), array('action' => 'delete', $apiApp['ApiApp']['id']), array('class' => 'btn btn-danger pull-right'), __('Are you sure you want to delete # %s?', $apiApp['ApiApp']['id'])); ?>
            </div>
        </div>
    </div>
</div>