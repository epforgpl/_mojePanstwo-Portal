...
<table class="formularz table table-bordered">
    ...
    <tr>
        <td>//Nr faksu (pole nieobowiązkowe)</td>
        <td>//e-mail (pole nieobowiązkowe)</td>
        <td colspan="2">//Strona www (pole nieobowiązkowe)</td>
    </tr>
    ...
    <tr>
        <td>//Imię</td>
        <td>//Nazwisko</td>
        <td>//PESEL (przypadku braku seria i nr dokumentu potwierdzającego tożsamość)</td>
        <td>//Kraj</td>
    </tr>
    <tr>
        <td>//Miejscowość</td>
    ...
    <tr>
        <td>//Kod pocztowy</td>
        <td>//Nr telefonu (pole nieobowiązkowe)</td>
        <td>//Nr faksu (pole nieobowiązkowe)</td>
        <td>//e-mail (pole nieobowiązkowe)</td>
    </tr>
    ...
    <tr>
        <td class="grey" rowspan="4">2. Cele, na które wydatkowano środki w okresie sprawozdawczym
        </td>
        <td colspan="2"></td>
        <td>, PLN</td>
    </tr>
    ...
    <tr>
        <td class="grey" rowspan="4">3. Kategorie i ilość albo wartość zebranych darów rzeczowych
        </td>
        <td colspan="2"></td>
        <td></td>
    </tr>
    ...
    <tr>
        <td colspan="3">//Imię i nazwisko</td>
        <td>//Podpis</td>
    </tr>
    <tr>
        <td colspan="3">//Imię i nazwisko</td>
