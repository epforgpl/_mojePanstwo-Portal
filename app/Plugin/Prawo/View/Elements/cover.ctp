	...
	<div class="databrowser-panels">
		...
		<div class="databrowser-panel">
			...
			<div class="aggs-init">
				...
				<div class="dataAggs">
					<div class="agg agg-PieChart" data-chart-options="<?= htmlentities(json_encode($options)) ?>" data-choose-request="dane/prawo?conditions[prawo.typ_id]=" data-chart="<?= htmlentities(json_encode($dataBrowser['aggs']['prawo_obowiazujace']['typ_id'])) ?>">
					    <div class="chart">
					    </div>
					</div>
				</div>
					    ...
					    <ul class="dataobjects">
							...
							?>
								<div class="objectRender-addons">
									<span class="">Wchodzi w życie <?= dataSlownie($doc['fields']['source'][0]['data']['prawo.data_wejscia_w_zycie']); ?>
								</div>
						    </li>
						    <? } ?>
					    </ul>
		...
		<div class="databrowser-panel">
			...
			<div class="aggs-init">
				...
				<div class="dataAggs">			
					<div class="agg agg-ColumnsHorizontal" data-choose-request="asd" data-chart="<?= htmlentities(json_encode($dataBrowser['aggs']['prawo_obowiazujace']['autor_id'])) ?>">
				        <div class="chart"></div>
				    </div>
				</div>
				...
				<div class="dataAggs">
					<div class="agg agg-Dataobjects">
					    ...
					    <ul class="dataobjects">
							...
							?>
							<div class="objectRender-addons">
									<span class="">Data wejścia w życie: <?= dataSlownie($doc['fields']['source'][0]['data']['prawo.data_wejscia_w_zycie']); ?>
								</div>
						    </li>
						    <? } ?>
					    </ul>
