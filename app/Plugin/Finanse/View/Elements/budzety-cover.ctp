                        ...
                        <a href="#PKB" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Produkt Krajowy Brutto"
                                         data-histogram='<?= json_encode($GDP['PKB']) ?>'>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="PKB_per_capita">
                        <a href="#PKB_per_capita" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Produkt Krajowy Brutto na osobę"
                                         data-histogram='<?= json_encode($GDP['PKB_per_capita']) ?>'>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="dlug">
                        <a href="#dlug" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Zadłużenie Sektora Finansów Publicznych"
                                         data-histogram='<?= json_encode($dlug) ?>'>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="bezrobocie">
                        <a href="#bezrobocie" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Stopa bezrobocia"
                                         data-histogram='<?= json_encode($bezrobocie) ?>'>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="budzet_dochody">
                        <a href="#budzet_dochody" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Dochody budżetu krajowego"
                                         data-histogram='<?= json_encode($dane_budzet['dochody']) ?>'>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="budzet_wydatki">
                        <a href="#budzet_wydatki" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Wydatki budżetu krajowego"
                                         data-histogram='<?= json_encode($dane_budzet['wydatki']) ?>'>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="budzet_deficyt">
                        <a href="#budzet_deficyt" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Deficyt budżetu krajowego"
                                         data-histogram='<?= json_encode($dane_budzet['deficyt']) ?>'>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="block col-xs-12 col-sm-6 col-md-3">
                    <div class="item" data-id="inflacja">
                        <a href="#inflacja" class="inner">
                            ...
                            <div class="highchart" style="display: none;">
                                <div class="histogram_cont">
                                    <div class="histogram" data-text="Inflacja"
                                         data-histogram='<?= json_encode($inflacja) ?>'>
                                    </div>
                                </div>
                            </div>
                        </a>
